...
helixMT<-read_tsv("/Users/leekapp/Desktop/STAT 235/STAT235Project/HelixMTdb.tsv")
...
aggCounts<-mutByGene %>% inner_join(geneDB, by = "gene") #merging helix data and mitomap data for df with gene, feature, total Hom and Het counts, and length
...
### Are different types of mutations equally likely?
